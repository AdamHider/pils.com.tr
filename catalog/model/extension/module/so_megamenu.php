                ...
                if(isset($array['categories'][$i]['id'])) {
                    ...
                    if(isset($info_category['category_id'])) {
                        ...
                        if(is_array($info_category)) {
                            ...
                            $output .= '<li><a href="'.$link.'" onclick="window.location = \''.$link.'\';" class="main-menu">';
                            
                            /*subcategory images */
                            if (isset($this->request->server['HTTPS']) && (($this->request->server['HTTPS'] == 'on') || ($this->request->server['HTTPS'] == '1'))) {
                                $image_link = $this->config->get('config_ssl') . 'image/' . $info_category['image'];
                            } else {
                                $image_link = $this->config->get('config_url') . 'image/' . $info_category['image'];
                            }
                            $output .= '<img src="'.$image_link.'"/>';
                            /*subcategory images */

                            $output .= '<label>'.$info_category['name'].'</label>';
